...
type AmendmentInformationDetails13 struct {
	...
	OrgnlFnlColltnDt *common.ISODate `xml:"OrgnlFnlColltnDt"`
...
type CreditTransferMandateData1 struct {
	...
	DtOfSgntr *common.ISODate `xml:"DtOfSgntr"`

	DtOfVrfctn *common.ISODateTime `xml:"DtOfVrfctn"`

	ElctrncSgntr *Max10KBinary `xml:"ElctrncSgntr"`

	FrstPmtDt *common.ISODate `xml:"FrstPmtDt"`

	FnlPmtDt *common.ISODate `xml:"FnlPmtDt"`
...
type DocumentLineIdentification1 struct {
	...
	RltdDt *common.ISODate `xml:"RltdDt"`
...
type MandateRelatedInformation14 struct {
	...
	FrstColltnDt *common.ISODate `xml:"FrstColltnDt"`

	FnlColltnDt *common.ISODate `xml:"FnlColltnDt"`
...
type OriginalGroupHeader18 struct {
	...
	OrgnlCreDtTm *common.ISODateTime `xml:"OrgnlCreDtTm"`
...
type SettlementDateTimeIndication1 struct {
	...
	DbtDtTm *common.ISODateTime `xml:"DbtDtTm"`

	CdtDtTm *common.ISODateTime `xml:"CdtDtTm"`
